(function()
{
    ...
    angular.module('VotingApp').controller('VoteController', VoteController);

    VoteController.$inject = ['$scope', '$state', '$uibModalInstance'];

    function VoteController($scope, $state, $uibModalInstance)
    {
        var vm = this;
