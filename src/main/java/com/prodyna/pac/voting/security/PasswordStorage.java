...
/**
 * Based an the following article: <a href="https://crackstation.net/hashing-security.htm" />, we want to secure our passwords in the database.
 * <p>
 * We'll using the implementation of Defuse.ca provided on github: <a href="https://github.com/defuse/password-hashing" />
 *
 * @author Defuse.ca
 */
