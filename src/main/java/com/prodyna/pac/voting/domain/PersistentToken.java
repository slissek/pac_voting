 ...
 *
 * @see com.prodyna.security.CustomPersistentRememberMeServices
 */
@Entity
...
public class PersistentToken implements Serializable
{
    ...
    {
        return "PersistentToken{" + "series='" + this.series + '\'' + ", tokenValue='" + this.tokenValue + '\'' + ", tokenDate="
                + this.tokenDate + ", ipAddress='" + this.ipAddress + '\'' + ", userAgent='" + this.userAgent + '\'' + "}";
    }
}
