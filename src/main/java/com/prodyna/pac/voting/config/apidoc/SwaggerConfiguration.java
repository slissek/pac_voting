package com.prodyna.pac.voting.config.apidoc;
...
@ConditionalOnProperty(prefix="voting.swagger", name="enabled")
public class SwaggerConfiguration {
     ...
     */
    @Bean
    public Docket swaggerSpringfoxDocket(final ApplicationProperties applicationProperties) {
