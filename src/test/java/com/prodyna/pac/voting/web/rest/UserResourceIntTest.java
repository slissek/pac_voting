...
public class UserResourceIntTest
{
    ...
    {
        this.userDTO = new ManagedUserDTO(null, DEFAULT_FIRST_NAME, DEFAULT_LAST_NAME, DEFAULT_USER_NAME, DEFAULT_PASSWORD,
    ...
    //
    // this.restUserMockMvc.perform(
    // post("/api/users").contentType(TestUtil.APPLICATION_JSON_UTF8).content(TestUtil.convertObjectToJsonBytes(this.user)))
    ...
    //
    // this.restUserMockMvc.perform(
    // put("/api/users").contentType(TestUtil.APPLICATION_JSON_UTF8).content(TestUtil.convertObjectToJsonBytes(updatedUser)))
    ...
    //
    // // Get the users
    // this.restUserMockMvc.perform(delete("/api/users/{id}", this.user.getId()).accept(TestUtil.APPLICATION_JSON_UTF8))
    // .andExpect(status().isOk());
    //
